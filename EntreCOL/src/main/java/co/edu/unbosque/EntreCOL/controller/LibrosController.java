...
public class LibrosController {
	...
	@PostMapping("/agregar")
	public ResponseEntity<String> agregar(@RequestParam Integer idlibro, @RequestParam String autores, @RequestParam String rating,
											@RequestParam String isbn, @RequestParam String isbn13, @RequestParam String idioma, 
											@RequestParam String paginas, @RequestParam Integer totalRatings, @RequestParam Integer totalResenas,
	...
	public ResponseEntity<String> actualizar(@RequestParam Integer idlibro1, @RequestParam Integer idlibro2, @RequestParam String autores, @RequestParam String rating,
											@RequestParam String isbn, @RequestParam String isbn13, @RequestParam String idioma, 
											@RequestParam String paginas, @RequestParam Integer totalRatings, @RequestParam Integer totalResenas,
											@RequestParam String fechaPublicacion, @RequestParam String publicador, @RequestParam String titulo){
